...
//	@Failure		400		{object}	model.ErrorResponse	"Bad request, check the error response for details"
//	@Router			/users [post]
...
//	@Success		404	string	model.ErrorResponse	"User not found"
//	@Success		400	string	model.ErrorResponse	"Invalid user ID"
